...
packages\OpenCover.4.6.519\tools\OpenCover.Console.exe -register:user -filter:"+[*]*" -target:"packages\NUnit.ConsoleRunner.3.6.1\tools\nunit3-console.exe" -targetargs:"/domain:single Skeleton.Tests.Infrastructure\bin\debug\Skeleton.Tests.Infrastructure.dll Skeleton.Tests.Core\bin\debug\Skeleton.Tests.Core.dll" -output:coverage.xml

...
//            _repository = new CachedCustomerRepository(accessorCache, cacheProvider, database);
//        }
...
//                CustomerCacheKey.ForFind(_repository.Query.AsSql())));
//        }

//        [TestMethod]
//        public void FirstOrDefault_ByExpression()
//        {
//            var customer1 = _repository.FirstOrDefault(c => c.Name.Equals("Foo"));
//            Assert.IsNotNull(customer1);
//            Assert.IsInstanceOfType(customer1, typeof(Customer));

//            var customer2 = _repository.FirstOrDefault(c => c.Name.Equals("Foo"));
...
//        {
//            var customer1 = _repository.Query.SelectTop(1).FirstOrDefault();
